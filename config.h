...
const std::vector<double> evader_parallels{1.5,3}; //This is really just the vision range
...
const std::vector<double> pursuer_parallels{6,12}; //This is really just the vision range
