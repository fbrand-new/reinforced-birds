EXE = main.x
CXX = g++
CXXFLAGS = -I include -std=c++14 -Wall -g -O3
...
$(EXE): main.o src/Observable.o src/State.o src/Agent.o src/RandomWalk.o src/Environment.o src/Policy.o src/Bird.o src/V.o src/Boltzmann.o src/Signal.o
	$(CXX) $^ -o $(EXE)

main.o: src/Observable.o src/State.o src/Agent.o src/RandomWalk.o src/Policy.o src/Environment.o src/Bird.o src/V.o src/Boltzmann.o src/Signal.o
